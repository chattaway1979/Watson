...
import { previewRemoval } from '@/lib/it-agent/rbac/service';
...
export async function POST(req: Request) {
  ...
  const r = await previewRemoval(actor, body.targetOid, body.role, typeof body.displayName === 'string' ? body.displayName : null);
